...
import { usePagination } from '../hooks/usePagination'; // import your pagination hook
...
const AdminDashboard = () => {
  ...
  // Pagination hook with 12 tickets per page
  const { limit, offset, next, prev, reset } = usePagination(12);

  const fetchTickets = async () => {
    setLoading(true);
    try {
      // fetch all tickets, then slice for pagination
  ...
  const styles = {
    ...
    main: { flex: 1, background: '#f5f5f5', minHeight: '100vh', borderRadius: '10px' },
            ...
            <div style={styles.grid}>
              {paginatedTickets.map(ticket => (
                ...
                >
                  ...
                  <p>Assignee: {ticket.assignee_id || 'Unassigned'}</p>
